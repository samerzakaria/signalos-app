        ...
        <div className="stack" style={{ 'maxWidth': '680px' }}>
          ...
          <div className="card">
            <div className="settings-section" style={{ 'padding': '0' }}>
              ...
              <div className="settings-row">
                <div className="settings-row-tx"><strong>Active folder</strong><span>The project Foundry is working in</span></div>
              ...
              <div className="settings-row">
                <div className="settings-row-tx"><strong>Forget this folder</strong><span>Removes it from Foundry — files stay on your computer</span></div>
          ...
          <div className="card">
            <div className="settings-section" style={{ 'padding': '0' }}>
              ...
              <div className="settings-row">
                <div className="settings-row-tx"><strong>Monthly cap</strong><span>Foundry stops calling the AI when you hit this</span></div>
          ...
          <div className="card">
            <div className="settings-section" style={{ 'padding': '0' }}>
              ...
              <div className="settings-row">
                <div className="settings-row-tx"><strong>Foundry engine</strong><span>Governance core · Python sidecar · 40 commands</span></div>
          ...
          <div className="card">
            <div className="settings-section" style={{ 'padding': '0' }}>
              ...
              <div className="settings-row">
                <div className="settings-row-tx"><strong>Version</strong><span>Foundry 3.0.0-internal.28</span></div>
