        ...
        <div className="term-wrap">
          ...
          <div className="term-foot">
            <div className="term-chips">
              <span className="term-chip" onClick={() => window.termChip(this)}>help</span>
              <span className="term-chip" onClick={() => window.termChip(this)}>signalos status</span>
              <span className="term-chip" onClick={() => window.termChip(this)}>signalos check</span>
              <span className="term-chip" onClick={() => window.termChip(this)}>signalos gates</span>
              <span className="term-chip" onClick={() => window.termChip(this)}>npm run dev</span>
              <span className="term-chip" onClick={() => window.termChip(this)}>git status</span>
              <span className="term-chip" onClick={() => window.termChip(this)}>clear</span>
            </div>
            <div className="term-input-row">
              <span className="term-prompt"><span className="t-path">my-pizza-game</span> <span className="t-sym">$</span></span>
              <input id="termInput" className="term-input" spellcheck="false" autocomplete="off" placeholder="type a command…" onKeyDown={(e) => window.termKey(event)}/>
            </div>
          </div>
        </div>
      </div>
