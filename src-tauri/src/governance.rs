...
impl GovernanceState {
    ...
    fn default_wave() -> WaveSnapshot {
        WaveSnapshot {
            ...
            belief_conf:  0,
            gates: vec![
                Gate { id: 0, name: "Constitution".into(),     desc: "Immutable project rules".into(),                     status: GateStatus::Signed,  signer: None, signed_at: None, artifacts: vec!["CONSTITUTION.md".into()] },
                Gate { id: 1, name: "Belief".into(),           desc: "Signed statement of what we believe".into(),         status: GateStatus::Signed,  signer: None, signed_at: None, artifacts: vec!["BELIEF.md".into()] },
                Gate { id: 2, name: "Expectation Map".into(),  desc: "Measurable success criteria for this wave".into(),   status: GateStatus::Current, signer: None, signed_at: None, artifacts: vec!["EXPECTATION_MAP.md".into()] },
                Gate { id: 3, name: "Plan".into(),             desc: "PLAN.md approved by PO".into(),                      status: GateStatus::Locked,  signer: None, signed_at: None, artifacts: vec!["PLAN.md".into()] },
                Gate { id: 4, name: "Trust Tier".into(),       desc: "All tasks declared T1/T2/T3".into(),                 status: GateStatus::Locked,  signer: None, signed_at: None, artifacts: vec!["PLAN.md (T-tier column)".into()] },
                Gate { id: 5, name: "Quality Check".into(),    desc: "Critical findings resolved, QUALITY_CHECK.md signed".into(), status: GateStatus::Locked, signer: None, signed_at: None, artifacts: vec!["QUALITY_CHECK.md".into()] },
            ],
        }
    }
}
