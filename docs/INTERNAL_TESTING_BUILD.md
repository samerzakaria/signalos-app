...
This file documents how to produce a v3.2.4-internal.1 build for **internal testing**
...
5. Writes `distribution/internal/attestation-<short-commit>.json` —
   ...
   ```json
   {
     ...
     "artifacts": [
       {
         "path": "src-tauri/target/release/bundle/nsis/Foundry_3.2.4-internal.1_x64-setup.exe",
         "size": 22118400,
         "sha256": "abc123..."
       }
     ],
...
Expected outputs:
```
src-tauri/target/release/bundle/nsis/Foundry_3.2.4-internal.1_x64-setup.exe
src-tauri/target/release/bundle/msi/Foundry_3.2.4-internal.1_x64_en-US.msi
...
Outputs by platform:
- macOS: `src-tauri/target/release/bundle/dmg/Foundry_3.2.4-internal.1_*.dmg`
- Linux: `src-tauri/target/release/bundle/{deb,appimage}/Foundry_3.2.4-internal.1_*.{deb,AppImage}`
...
> Hi — this is an **internal testing build** of Foundry v3.2.4-internal.1.
...
```bash
# 1. Tester downloads Foundry_3.2.4-internal.1_x64-setup.exe + attestation-5284391.json
