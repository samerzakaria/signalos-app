...
# SignalOS Core v1.1 — Codex emitter: W1.1 hook registration.
#
# Codex's config surface is AGENTS.md (command registry table) plus
# codex.md (preamble). We append a "## SignalOS W1.1 hooks" section to
# AGENTS.md listing the 4 events. Idempotent via a marker comment.
...
echo "codex/register-hooks.sh: updated $DEST"
