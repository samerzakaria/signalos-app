...
## Your first action
Read `core/governance/Governance/SOUL-DOCUMENT.md` and `core/execution/Plans/wave-{N}-plan.md`.
Confirm plan is signed and acceptance criteria document exists.
...
4. **Spec re-check** — before picking up the next ticket, re-read `core/execution/Plans/wave-{N}-acceptance-criteria.md`. If specs or priorities have changed, re-scope before coding resumes.
